...
<html>
  ...
  <body>
		...
		<nav class="navbar-nav navbar-expand-sm  style="margin:0px;padding:0px; id="bg">
...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<img src="admin.png" style="border-radius:15%;margin-left:25%;float:left" width="70px" height="80px">
				<h3  style="float:left;cursor:pointer;margin:20px 2px 0px 20px;"><b style="color:white;">Admin</b></h3>
						
		</div>
				<div style="width:50%" >
				<a class="btn btn-success" style="float:right;padding-left:30px;padding-right:30px;margin:15px;" href="adminlogin1.html">Logout</a>
		</div>
		...
		<nav  class="navbar navbar1 bg-dark" style="float:left;margin:0px;display:block;padding:0px;box-shadow:.2px 1px 2px 1px;" id="sh_menu">
			...
			<ul class="navbar-nav" style="width:100%;">
				...
				<li class="nav-item" style="width:100%;border-bottom:2px solid white;" >
					<a class="btn btn-dark btn1" onclick="dashboard()" href="#"><b> Dashboard </b> </a>
				</li>
				<li class="nav-item">
					<a class="btn btn-dark btn1" onclick="comp()" href="#"><b> Manage Complaints </b></a>
				</li>
				<li class="nav-item"  id="p_comp" style="display:none;border-top:1.2px solid white;">
					<a class="btn btn-dark btn1" onclick="pending()" href="#"><b>Pending </b><br/> <b>complaints</b><p id="specialchk"><?php echo $pend;?></p></a>
				</li>
				<li class="nav-item" id="i_comp"  style="display:none"> 
					<a class="btn btn-dark btn1" onclick="inpro()"  href="#"><b>In progress </b><p id="specialchk"><?php echo $inpro;?></p></a>
				</li>
				<li class="nav-item" id="ccomp" style="display:none;">
					<a class="btn btn-dark btn1" onclick="complcomp()"href="#"><b>Complete </b> <br /><b>Complaints </b><p id="specialchk"><?php echo $compl; ?></p></a>
				</li>
				<li class="nav-item" id="f_comp" style="display:none;">
					<a class="btn btn-dark btn1" onclick="full()"  href="#"><b>Full Complaint</b><br /><b> history</b><p id="specialchk"><?php echo $full;?></p></a>
				</li>
					
				<li class="nav-item"  style="border-top:2px solid white;">
					<a class="btn btn-dark btn1" onclick="manageuser()" href="#"><b>Manage Users</b></a>
				</li>
				<li class="nav-item" id="a_user" style="display:none;border-top:1.2px solid white;">
					<a class="btn btn-dark btn1" onclick="auser()"   href="#"><b>All users data</b></a>
				</li>
				<li class="nav-item" id="l_user"  style="display:none">
					<a class="btn btn-dark btn1" onclick="luser()"   href="#"><b> User Login info </b></a>
				</li>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<h4>&#10071; <b>Pending Complaints </b><hr /></h4>
				<?php
					$query1="SELECT * FROM `complaints`";
					$result=mysqli_query($conn,$query1);
						$num=0;
			...
			<h4> &#x23F3; <b>In progress Complaints</b><hr /></h4>
			<?php
				$num=0;
				$query1="SELECT * FROM `complaints`";
			...
			<h4> &#10004; <b>Completed Complaints</b><hr /></h4>
				<?php
				$num=0;
				$query1="SELECT * FROM `complaints`";
			...
			<h3>&#x1F4D2; <b>Full history of Complaints </b><hr /></h3>
				<h4>&#10071; <b>Pending Complaints</b><hr /></h4>
				<?php
					$query1="SELECT * FROM `complaints`";
					$result=mysqli_query($conn,$query1);
						...
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						echo "<br /br /><h4><b>Inprogress Complaints</b><hr /></h4>";
						$num=0;
				$query1="SELECT * FROM `complaints`";
				$seee="SELECT * FROM `inprogresscomp`";
				$reso=mysqli_query($conn,$seee);
					...
					/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						echo "<br /br /><h4>&#10004; <b>Completed Complaints </b><hr /></h4>";	
